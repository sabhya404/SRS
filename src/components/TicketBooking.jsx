...
export default function TicketBooking({ eventId }) {
  ...
  const getSeatColor = (seat) => {
    ...
    if (isSelected) {
      return "#4caf50"; // Green for selected seats
    }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3">
          <Card>
            ...
            <CardContent>
              <div className="overflow-auto p-4 border rounded-md bg-gray-50">
                <div
                              ...
                              <TooltipTrigger asChild>
                                <div
                                  className={`
                                    ...
                                    ${isSelected ? "border-green-600 border-2" : "border-gray-300"}
                                    ${isBookable ? "cursor-pointer hover:opacity-80" : "cursor-not-allowed opacity-70"}
                                  `}
                                  style={{
